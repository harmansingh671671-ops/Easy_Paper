    ...
    >
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-gray-900">
          {creationSuccess ? 'Question Created!' : 'Create New Question'}
        </h2>
      ...
      {creationSuccess ? (
        <div className="text-center py-4">
          ...
          <div className="flex justify-center gap-4">
            <button onClick={handleClose} className="px-6 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200">
              Go to Dashboard
            </button>
            <button onClick={handleCreateAnother} className="px-6 py-2 text-white bg-indigo-600 rounded-lg hover:bg-indigo-700">
